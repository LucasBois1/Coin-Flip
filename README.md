...
Version 1.5 [ With UI ]
-
Includes a compiled file made with PyInstaller, compiled for Windows.

Version 1.2 [ With UI ]
-
slight changes in the main.py file, and creation of the ui.py file, which is now the main one, since it opens the GUI that manipulates the main.py, capable of generating the data of the simulations.

Version 1.0 [ Console ]
-
This version works only with inputs and has no UI. So you have to have python 2 installed to run it.

[GNU License](https://github.com/LucasBois1/Coin-Flip/blob/master/LICENSE)
